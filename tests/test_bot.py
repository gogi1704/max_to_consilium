...
class HandlerTests(unittest.IsolatedAsyncioTestCase):
    ...
    def test_docker_deployment_is_isolated_and_polling_disables_webhook(self) -> None:
        ...
        self.assertIn("consilium = ConsiliumClient(settings)", source)
        self.assertIn("register_handlers(dispatcher, consilium)", source)
        self.assertIn("await consilium.pull_manager_notifications()", source)
